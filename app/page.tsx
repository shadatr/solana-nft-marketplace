...
export default function Home() {
  ...
  return (
    <div>
      ...
      <p className="lg:text-lg sm:text-md p-3 text-secondary font-bold text-center">
      ...
      <Link href={'/shop'} className="text-center text-secondary border-2 border-pink py-3 px-6 text-md rounded-2xl ">Shop Now</Link> 
      </p>
    </WavyBackground>
    </div>
  );
